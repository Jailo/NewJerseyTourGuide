...
public class BedAndBreakfastsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        places.add(new Place("The Wooden Duck Bed & Breakfast", "Hotel",
                "Newton", R.drawable.wooden_duck));

        places.add(new Place("Sand Castle Bed & Breakfast", "Hotel",
                "Barnegat Light", R.drawable.sand_castle));

        places.add(new Place("The Majestic Hotel", "Hotel",
